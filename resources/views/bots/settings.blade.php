                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        ...
                        <form action="{{ route('bots.updateSettings', $bot) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="activity" class="block text-sm font-medium text-gray-700 mb-1">Bot Activity</label>
                                <input type="text" name="activity" id="activity" value="{{ old('activity', $bot->activity) }}"
                                       class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                       required>
                                @error('activity')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
